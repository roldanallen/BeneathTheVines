...
screen quick_menu():
    ...
    if quick_menu:
        ...
        #hbox:
            ...
            #textbutton _("History") action ShowMenu('history_screen')#, renpy.curried_call_in_new_context("_hide_windows")
            #textbutton _("Skip") action Skip() alternate Skip(fast=True, confirm=True)
            #textbutton _("Auto") action Preference("auto-forward", "toggle")
            #textbutton _("Save") action ShowMenu('save')
            #textbutton _("Q.Save") action QuickSave()
            #textbutton _("Q.Load") action QuickLoad()
            #textbutton _("Prefs") action Show('screen_setting', transition=dissolve)
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Settings") action ShowMenu("screen_setting", transition=dissolve)
...
style main_menu_frame:
    ...
    background "images/main_screen/main_screen.png"
